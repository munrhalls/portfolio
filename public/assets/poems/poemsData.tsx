...
const poemOne = {
  ...
  content: (
    <>
      ...
      <p>
        A slight hurricane even, is but another invisibility, presenting no
        difference, same as nothing.
      </p>
      <p>How can you drink, from a bottle like this?</p>
      ...
      <p>They quench one and only one, kind of thirst:</p>
      <p>the thirst of all thirsts.</p>
      <p> Even those that exist only, in the realm of possibilities.</p>
      <p>
        It is for this reason, that no pair of quench and thirst, ever tried to
        drink apart, from the one table.
      </p>
      <p>Except, of course, all the fictional stories.</p>
