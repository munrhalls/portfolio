          ...
          <Accordion>
              ...
              <Accordion.Body style={{ background: "#000" }}>
                <CustomParagraphsGroup>
                  <p>
                    ...
                    practical problem-solving abilities and delivering software
                    tasks under time pressure.
                  </p>
                </CustomParagraphsGroup>
                <CustomParagraphsGroup>
                  <p>
                    Frequent exposure familiarized me with the scenario of being
                    new to a very large codebase.
                  </p>
                  <p>
                ...
                <CustomParagraphsGroup>
                  <p>
                    ...
                    pressures, and problems invovled with, the product releases
                    every two weeks.
                  </p>
                </CustomParagraphsGroup>
                <CustomParagraphsGroup>
                  <p>
                    ...
                    "daily" and talking about software, from which I learned how
                    to form my thoughts about it in a simple, clear and concise
                    manner.
                  </p>
                </CustomParagraphsGroup>
                <CustomParagraphsGroup>
              ...
              <Accordion.Body style={{ background: "#000" }}>
                <CustomParagraphsGroup>
                  ...
                  <ul>
                    ...
                    <hr />
                    <li>
                      by practicing solving coding challenges on platforms such
                      as codewars.com
                    </li>
                    <hr />
                ...
                <CustomParagraphsGroup>
                  <ul>
                    ...
                    <li>
                      ...
                      multidimensional arrays and objects, deep vs shallow copy,
            ...
            <Accordion.Item eventKey="4">
              ...
              <Accordion.Body style={{ background: "#000" }}>
                <CustomParagraphsGroup>
                  <p>
                    I've learned that attacking the problem head-on almost never
                    works, nor is it worth it to skip basic preparation and just
                    go at it.
                  </p>
                  <p>
                ...
                <CustomParagraphsGroup>
                  ...
                  <ul>
                    ...
                    <li>it has to be clear how the components fit together</li>
                    <li>
                ...
                <CustomParagraphsGroup>
                  ...
                  <p>
                    ...
                    together, make tasks to push it forward, and then tackle one
                    small priority at a time.
                  </p>
                </CustomParagraphsGroup>
              </Accordion.Body>
            </Accordion.Item>
