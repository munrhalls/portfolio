          ...
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body style={{ background: "#000" }}>
              <CustomParagraphsGroup>
                ...
                <p>
                  I don't mean just a framework, for example, Angular or Vue, or
                  jQuery in the old days. I mean it more broadly, as an approach
                  to any work in general. If there's any scale or high
                  repeatability to the endeavor, not crafting a framework for it
                  is a giant waste of time.
                </p>

                <p>
                  I learned some very painful lessons from certain attempts and
                  they are that not determing a framework first (even if it
                  technically won't use any framework), is a waste of time.
                </p>
                <p>
                ...
                <p>
                  ...
                  some sorts - even if technically, it's just
                  Javascript/HTML/CSS, it's still worth it to determine some
                  baseline of tools and techniques to work at it effectively.
                </p>
                <p>
                ...
                <hr />
                <p>
                  In short, for what experience I've got, it's better to have a
                  lack of one-off's, rather than a lack of framework on a
                  project. Usually, it's either one or the other.
                </p>
              </CustomParagraphsGroup>
              ...
              <CustomParagraphsGroup>
                ...
                <p>
                  ...
                  isolation but none of that is whole or thorough, in terms of
                  my level, yet.
                </p>
                <p>
                  I can apply basic OOP in practice and I like it. For example,
                  I can write a basic board using classes.
                </p>
                <p>
              ...
              <CustomParagraphsGroup>
                ...
                <ul>
                  <li>
                    I've tried, failed and succeeded a whole bunch of various
                    web applications, mostly in Javascript/HTML/CSS/React and
                    from this, I have a reasonable, basic sense for solving
                    common problems
                  </li>
                  <hr />
                  <li>
                  ...
                  <li>
                    ...
                    prototype'ing of what I'm going to do, in what order, how
                    and ABCD's of if A's unavailable, then B, if B's
                    unavailable, then C etc., what are the biggest
                    threats/opportunities relative to time, note most important
                    points
                  </li>
                  <hr />
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        way, than with the "break it into sub-problems" because
                        it keeps the chain-links intact, all stays as one whole
                      </li>
                    </ul>
                    <hr />
                    <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        baby-stepping through tests & confirmations to advance
                        that idea in very small iterations. This way, steps
                        themselves tend to pre-solve a lot of problems and
                        everything stays connected, it's all one thing, one
                        idea, all along.
                      </li>
                    </ul>
                  </li>
                  <hr />
                  <li>
                    I also look at problem solving similar to how a coach looks
                    at a football match - if a given strategy doesn't work, I
                    try another one and I want to have a varied arsenal of
                    solving strategies at my disposal
                  </li>
                  <li>
                    The core of it has to do with puzzles, bigger picture and
                    navigating back and forth in order to fit more and more
                    pieces to clarify it...at some point, it becomes clear
                    enough, you start getting "aha" after "aha" moment and you
                    solve it.
                  </li>
                  <hr />
                  <li>
                    A very influential teacher for me, has been Mr.
                    <i> V. Anton Spraul</i>, both from his book "Think like a
                    programmer", as well as his series on problem solving on
                    youtube - it's all about how trial & error is inefficient,
                    how you never want to just attack the problem head on, and
                    how you always want to have a plan and act systematically
                    towards figuring out a solution, and how you can do so, even
                    if a problem is far too complex to see any clear path; it's
                    all patterns and strategy, coherent motion can be
                    maintained.
                  </li>
                  <hr />
                  <li>
                    One interesting thing, at least in my opinion, is that it's
                    often a very gradual onramp that then speeds up quite
                    rapidly, solving often looks like an avalanche of
              ...
              <CustomParagraphsGroup>
                ...
                <p>
                  ...
                  subjective exploration. It's important to my ability to solve
                  software things faster. This being relevant to anyone else - I
                  have no idea, so please be warned.
                </p>
                ...
                <p>
                  ...
                  sits on a rock and ponders philosophical questions. I just
                  mean a practical approach, an overall sum-total take on how to
                  best go about things.
                </p>
                <p>
                  ...
                  philosophy. A range of concepts, ideas, ideals, approaches,
                  tools, frames, ways of looking and whatever else fits, that
                  makes it possible, easier, real and reliable to form a way of
                  operating that's more efficient, effective and satisfactory
                  than most alternatives.
                </p>
                <p>
                  Focusing on just results doesn't work. Focusing on just
                  process doesn't work. Focusing on coherent assemble between,
                  and of, these two, also can easily work very poorly and
                  deficiently.
                </p>
                <hr />
                ...
                <p>
                  ...
                  anyway and you won't have time to guarantee the answers via
                  science.
                </p>
                <p>
                ...
                <p>
                  ...
                  relate it to time. Whatever matters, matters because of
                  timing, more than the matter of it. Anyone can do anything in
                  infinite time. Fundamental understanding is not a theory and
                  it is not a waste of time. It's a well of real accelerations.
                </p>
                <p>
                  I read somewhere that, in science, understanding the origin of
                  a thing, gives insight into the inner dimensions of how that
                  thing works. Every instance of people developing some app,
                  contains a portion of analogy of how software itself has
                  developed. This is analogous to how in chess, every principle
                  is present in every position.
                </p>
                <hr />
                <p>
                  Currently, my most useful understanding is that software
                  development is "managed snowball". In developing a solution,
                  every action point potentially can be made to contribute
                  towards the snowball effect. Snowball effect is that
                  everything has gotten a tiny little bit easier. Enough of
                  these tiny little bits adds up to significant acceleration -
                ...
                <p>
                  ...
                  item could have individual one-off consequences that would
                  need to be dealt with on individual basis. Complication begets
                ...
                <p>
                  ...
                  symbolic meanings, geometry and arming intuition with items
                  that help it reliably deliver that which speeds up coherent
                  solving processes.
                </p>
                <hr />
                <p>
          ...
          <Accordion.Item eventKey="5">
            ...
            <Accordion.Body style={{ background: "#000" }}>
              <CustomParagraphsGroup>
                ...
                <p>
                  - AI is and will transform the landscape in ways that are very
                  hard even begin predicting but the one thing that will remain,
                  is problems, and thus, problem solving abilities are here to
                  stay
                </p>
                <p>
              ...
              <CustomParagraphsGroup>
                ...
                <p>
                  - in a similar vein, this is just peculiarly interesting to me
                  for some reason, more than all the other things
                </p>
              </CustomParagraphsGroup>
              <CustomParagraphsGroup>
                <h3>
                ...
                <p>
                  ...
                  necessarily want to make into a job, although I could, I don't
                  know
                </p>
                <p>
                  - whatever the case, it's one of my major interests to
                  contribute some very curious and highly advanced things, as it
                  pertains to this direction
                </p>
              </CustomParagraphsGroup>
            </Accordion.Body>
          </Accordion.Item>
