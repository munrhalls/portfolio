        ...
        <Accordion defaultActiveKey="0">
          ...
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body>
              ...
              <p>
                ...
                or jQuery in the old days. I mean it more broadly, as an
                approach to any work in general. If there's any scale or high
                repeatability to the endeavor, not crafting a framework for it
                is a giant waste of time.
              </p>
              <p>
                I learned very painful lessons from certain attempts and they
                are that not determing a framework first (even if it technically
                won't use any framework), is a waste of time.
              </p>
              <p>
                Work is doing the marathon by foot because it's easier to start
                that way. Framework is build that bicycle or surfing board or
                little flying artifice, first.
              </p>
              <p>
                There is never a reason to do a project without a framework of
                some sorts - even if technically, it's just Javascript/HTML/CSS,
                it's still worth it to determine some baseline of tools and
                techniques to work at it effectively.
              </p>
              <p>
                Lack of framework means one-off's. One-off's are a plague. By
                "one-off" I mean some thing to be done that is handled
                individually - managing any large amount of such things is an
                absolute nightmare.
              </p>
              <p>
                In short, it's better to have a lack of one-off's, rather than a
                lack of framework on a project. It's either one or the other.
              </p>
              ...
              <p>
                I can apply basic OOP in practice and I like it. For example, I
                can write a basic board using classes.
              </p>
              <p>
                I am also aware of criticism to OOP, mainly from Rich Hickey's
                talks (creator of Clojure) but I am not able to verify it one
                way or another, no personal experience with larger projects
                that'd enable me a whole and realistic confirmation.
              </p>
              <h4>Problem solving</h4>
              <p>
                - I've tried, failed and succeeded a whole bunch of various web
                applications, mostly in Javascript/HTML/CSS/React and from this,
                I have a reasonable, basic sense for solving common problems
              </p>
              <ul>
                <li>
                  I learned that planning solution is useless as soon as you
                  start but absolutely essential to succeed at it
                </li>
                <li>
                  I always try to do some rapid, quick, no-nonsense planning &
                  prototype'ing of what I'm going to do, in what order, how and
                  ABCD's of if A's unavailable, then B, if B's unavailable, then
                  C etc., what are the biggest threats/opportunities relative to
                  time, note most important points
                </li>
                <li>
                  I also employ the idea that developing solution is a better
                  frame to look trough than the frame of problem solving
                  <ul>
                    <li>
                      Developing a solution is about starting from a core idea
                      and then gradually unwinding it with checks & tests of
                      what works
                    </li>
                    <li>
                      It's easier to de-compose & assemble the solution that
                      way, than with the "break it into sub-problems" because it
                      keeps the chain-links intact, all stays as one whole
                    </li>
                  </ul>
                  <p>Example: </p>
                  <ul>
                    <li>
                      ...
                      Redux/React/Typescript, for CREATE/READ/UPDATE/DELETE of
                      html tags + texts.
                    </li>
                    <li>
                      Developing a solution doesn't mean breaking it into parts,
                      it means starting from prototype and baby-stepping through
                      tests & confirmations to advance that idea in very small
                      iterations. This way, steps themselves tend to pre-solve a
                      lot of problems and everything stays connected, it's all
                      one thing, one idea, all along.
                    </li>
                  </ul>
                </li>
                <li>
                  I also look at problem solving similar to how a coach looks at
                  a football match - if a given strategy doesn't work, I try
                  another one and I want to have a varied arsenal of solving
                  strategies at my disposal
                </li>
                <li>
                  The core of it has to do with puzzles, bigger picture and
                  navigating back and forth in order to fit more and more pieces
                  to clarify it...at some point, it becomes clear enough, you
                  start getting "aha" after "aha" moment and you solve it.
                </li>
                <li>
                  One interesting thing, at least in my opinion, is that it's
                  often a very gradual onramp that then speeds up quite rapidly,
                  solving often looks like an avalanche of realizations - it's
                  hardest and slowest at the onset
                </li>
              </ul>
              <p>
                - a decent additional asset for me, is experience from codewars
                - it has the best feedback cycle out of all the platforms and
                that makes all the difference for me in a practical way
              </p>
              <p>
                - in my view, a great deal of it all is just pattern
                recognition, and that's what I've got from codewars, at least to
                a basic degree with javascript
              </p>
              ...
              <p>
                ...
                exploration. It's important to my ability to solve software
                things faster. This being relevant to anyone else - I have no
                idea, so please be warned.
              </p>
              <h4>"Philosophy"? Seriously?</h4>
              <p>
                I don't mean the philosophy where some serious-looking persona
                sits on a rock and ponders philosophical questions. I just mean
                a practical approach, an overall sum-total take on how to best
                go about things.
              </p>
              <p>
                However, this approach DOES - and as the single, most important
                aspect of it all - contain the questions about what's really
                there and what matters about, and that's philosophy. A range of
                concepts, ideas, ideals, approaches, tools, frames, ways of
                looking and whatever else fits, to form a way of operating
                that's more efficient, effective and satisfactory than most
                alternatives.
              </p>
              <p>
                Focusing on just results doesn't work. Focusing on just process
                doesn't work. Focusing on coherent assemble between, and of,
                these two, also can easily work very poorly and deficiently.
              </p>
              <p>Why not just science, then?</p>
              <p>
                Whatever science is done, it's just such a fraction of how
                reality works, even in a specific domain, that it's never really
                legitimate to just do science. You will be guessing anyway and
                you won't have time to guarantee the answers via science.
              </p>
              <p>
                Reality's way too big and complex to have the time to do the
                proper science on everything. So what's left is philosophy -
                what's there and what works best based on that. Science is the
                other half of it, to balance it, to keep it real.
              </p>
              <h4>
                My (humble and all-over-the-place) learnings about what truly
                matters and is most effective for software development
              </h4>
              <p>
                Everything is time, in a way. Whatever I mention here, I will
                relate it to time. Whatever matters, matters because of timing,
                more than the matter of it. Anyone can do anything in infinite
                time. Fundamental understanding is not a theory and it is not a
                waste of time. It's a well of real accelerations.
              </p>
              <p>
                I read somewhere that, in science, understanding the origin of a
                thing, gives insight into the inner dimensions of how that thing
                works. Every instance of people developing some app, contains a
                portion of analogy of how software itself has developed. This is
                analogous to how in chess, every principle is present in every
                position.
              </p>
              <p>
                Currently, my most useful understanding is that software
                development is "managed snowball". In developing a solution,
                every action point potentially can be made to contribute towards
                the snowball effect. Snowball effect is that everything has
                gotten a tiny little bit easier. Enough of these tiny little
                bits adds up to significant acceleration - the snowball's
                rolling.
              </p>
              <p>
                Conversly, it's about managing minimal friction. Anything that
                is done that keeps other things hard, is a one-off and it
                translates to friction. If a change was required, every item
                would need to be changed individually. That also means, every
                item could have individual one-off consequences that would need
                to be dealt with on individual basis. Complication begets
                complication. Friction begets more friction.
              </p>
              <p>
                This "managed snowball" seems to be all about dichotomic
                balancing: two opposite extremes and finding the right range
                between them for a given snowball-to-problem type.
              </p>
              <p>
                For example, if you keep a thing too big, you bang your head
                against a wall. If you split it up too atomically, there's so
                much of it, it all becomes sand, too complex. If you find the
                right range between, it's neither too big, nor too granular,
                it's a much better fit for solving.
              </p>
              <p>
                Managed snowball is, mostly, a function of fit. It's
                fitsForDevelopmentSnowball(x) ~ y, for choosing the right next
                step.
              </p>
              <p>
                The reality of translating it to practical use, has to do with
                symbolic meanings, geometry and arming intuition with items that
                help it reliably deliver that which speeds up coherent solving
                processes.
              </p>
              <p>
                In real terms, I don't know - it's just a bunch of ideas that
                help to bundle everything into a more coherent whole, when
                solving anything. It's like a framework for solving, for me.
              </p>
              ...
              <p>
                "Time pushes", setting X to complete in 3 pomodoros, mapping it
                out, doing my best, then feedback, like it was a mission
              </p>
              <h3>
                Improving development philosophy for being the most effective
                developer I can be
              </h3>
              <p>
                I seek that which is the most formative, usable coherent whole
                of concepts, techniques, pricinples and how to use them, a
                framework for developing all kinds of things very effectively.
              </p>
              <h3>Developing software to learn developing software</h3>
              <p>
                Developing shows me where my limits and biggest time-sinks,
                worst weaknesses are. Time-sinks and weaknesses are where I
                place my focus on adapting, as I keep developing.
              </p>
              <p>
                Tried many more approaches but they are all less direct and work
          ...
          <Accordion.Item eventKey="5">
            ...
            <Accordion.Body>
              ...
              <h3>
                Developing multidimensional, highly abstract, spatial virtual
                constructs
              </h3>
              <h3>
                Enabling new, vaster and richer forms of digital multimedia,
                games and art
              </h3>
            </Accordion.Body>
          </Accordion.Item>
